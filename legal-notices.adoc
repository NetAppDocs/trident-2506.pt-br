...
Você pode consultar os direitos autorais e as licenças de terceiros usados ​​no software NetApp para Trident no arquivo de avisos de cada versão em https://github.com/NetApp/trident/[] .
