...
O tamanho do bloco e a largura de banda influenciam diretamente o número de IOPS. À medida que o tamanho do bloco aumenta, o sistema aumenta a largura de banda para um nível necessário para processar os blocos maiores. À medida que a largura de banda aumenta, o número de IOPS que o sistema consegue atingir diminui. Consulte  https://www.netapp.com/pdf.html?item=/media/10502-tr-4644.pdf["Qualidade de serviço SolidFire"^] para mais informações sobre QoS e desempenho.
...
* https://www.netapp.com/pdf.html?item=/media/10511-tr4606.pdf["Melhores práticas da Oracle no SolidFire"^]
