...
*** *spec.storageClassName*: (_Obrigatório_) Escolha o nome de uma classe de armazenamento válida no cluster.  A classe de armazenamento deve ser vinculada a uma VM de armazenamento ONTAP que esteja emparelhada com o ambiente de origem.
*** *spec.recurrenceRule*: Define uma data de início em UTC e um intervalo de recorrência.
+
Exemplo de YAML:
