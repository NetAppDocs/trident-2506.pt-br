...
summary: 'Crie um PersistentVolume (PV) e um PersistentVolumeClaim (PVC) que utilize a StorageClass do Kubernetes configurada para solicitar acesso ao PV.  Em seguida, você pode montar o painel fotovoltaico em um suporte.' 
---
= Forneça um volume
:hardbreaks:
:allow-uri-read: 
