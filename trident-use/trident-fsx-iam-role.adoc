...
NOTE: Para autenticar usando uma função do AWS IAM, você precisa ter um cluster Kubernetes implantado usando o EKS.
...
----
Para obter mais informações, consultelink:https://docs.aws.amazon.com/eks/latest/userguide/pod-id-agent-setup.html["Configure o agente de identidade do Amazon EKS Pod."] .
