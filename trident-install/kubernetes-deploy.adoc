...
Selecione o método de instalação mais adequado para você. Você também deve analisar as considerações para link:../trident-install/kubernetes-deploy.html#moving-between-installation-methods["alternando entre métodos"] antes de tomar sua decisão.
